...
#
# Example:
# The following command runs the llm-jp-4-8b-instruct model with the llmjp4 reasoning parser.
# python example_cli.py serve llm-jp/llm-jp-4-8b-instruct --reasoning-parser llmjp4 --trust-remote-code
